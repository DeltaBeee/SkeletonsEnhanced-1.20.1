...
public class JungleSkeleton extends BaseSkeleton implements GeoEntity {

    public JungleSkeleton(EntityType<? extends AbstractSkeleton> pEntityType, Level pLevel) {
