...
public class MushroomSkeleton extends BaseSkeleton implements GeoEntity {

    public MushroomSkeleton(EntityType<? extends AbstractSkeleton> pEntityType, Level pLevel) {
